                            ...
                            <thead>
                                <tr class="data-tr">
                                    <th colspan="6">
                                        ...
                                        <el-tooltip v-if="item.vendorId > 0" :content="'订单来自供应商：' + item.vendorName" effect="light" placement="top">
...
import { batchSubmit, getOrderList, operationOrder, getOrderPageConfig, changeOrderStatus, remindDeliver } from "@/api/order/order";
